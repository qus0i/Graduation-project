  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="50" height="50">
    <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5
        ...
        <div class="ps-md-4 d-flex flex-column  " style="height: 100%;">
                ...
                <div class="3">
                  <div class="star-rating pb-2 me-1" style="width:23%" data-tooltipr="Book Rating" >
                    ★<span class="fs-1">${Number(rating).toFixed(1)}/5.0</span>
                  </div>
<div class="d-flex align-items-center justify-content-start" style="height: 100px;width:25.1%;"  data-tooltipr="Community Rating">
